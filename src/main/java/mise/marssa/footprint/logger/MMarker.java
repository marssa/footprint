...
public final class MMarker {
	...
	public final static Marker CONNECTION = MarkerFactory
			.getMarker("CONNECTION");
	public final static Marker CONSTRUCTOR = MarkerFactory
			.getMarker("CONSTRUCTOR");
	public final static Marker JSONSERIALIZATION = MarkerFactory
			.getMarker("JSONSERIALIZATION");
